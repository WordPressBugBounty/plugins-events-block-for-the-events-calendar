...
/* harmony import */ var _styling_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./styling.js */ "./src/Block/styling.js");
...
class EventBlocks extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor() {
    ...
    this.ref = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createRef)();
  }
  getDocument() {
    const iframe = document.querySelector('iframe[name="editor-canvas"]');
    return this.ref?.current?.ownerDocument || iframe?.contentDocument || document;
  }
  ...
  render() {
    ...
    if (doc) {
      ...
      if (element) {
        element.textContent = (0,_styling_js__WEBPACK_IMPORTED_MODULE_9__["default"])(this.props);
      }
    }
    const {
      attributes,
    ...
    return isPreview ? /*#__PURE__*/React.createElement("img", {
      ...
      eventHeaderTypeHandle: v => setAttributes({
        event_header_type: v
      })
      ...
      eventSimpleColorHandle: v => setAttributes({
        event_simple_color: v.hex
      })

      //Featured Event Style
      ,
      eventFeaturedColor: event_featured_color,
      eventFeaturedColorHandle: v => setAttributes({
        event_featured_color: v.hex
      })
    }), /*#__PURE__*/React.createElement("div", _extends({}, this.props.wrapperBlockProps || {}, {
...
const EventBlocksWithData = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_7__.compose)([(0,_wordpress_data__WEBPACK_IMPORTED_MODULE_6__.withSelect)((select, props) => {
  const {
    attributes
  } = props;
  const {
...
function Edit(props) {
  ...
  return /*#__PURE__*/React.createElement(EventBlocksWithData, _extends({}, props, {
    wrapperBlockProps: blockProps
  }));
}
...
class Inspector extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  render() {
    ...
    return /*#__PURE__*/React.createElement(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, {
      title: __("Event Panel", "events-block-for-the-events-calendar")
    ...
    }, "Select Event Date option only works on front-end side"), /*#__PURE__*/React.createElement(SelectControl, {
      __next40pxDefaultSize: true,
      ...
      title: __("Start Event Panel", "events-block-for-the-events-calendar"),
      className: "ebec-start-date-picker"
      ...
      title: __("End Event Panel", "events-block-for-the-events-calendar"),
      className: "ebec-end-date-picker"
    }, /*#__PURE__*/React.createElement(DateTimePicker, {
      ...
      title: __("Main Skin Color", "events-block-for-the-events-calendar"),
      initialOpen: false
      ...
      title: __("Event Date Style", "events-block-for-the-events-calendar"),
      initialOpen: false
    }, /*#__PURE__*/React.createElement(ColorPicker, {
      ...
      title: __("Event Title Style", "events-block-for-the-events-calendar"),
      initialOpen: false
    }, /*#__PURE__*/React.createElement(ColorPicker, {
      ...
      title: __("Event Venue Style", "events-block-for-the-events-calendar"),
      initialOpen: false
    }, /*#__PURE__*/React.createElement(ColorPicker, {
      ...
      title: __("Event Description Style", "events-block-for-the-events-calendar"),
      initialOpen: false
    }, /*#__PURE__*/React.createElement(ColorPicker, {
      ...
      title: __("Find out More Style", "events-block-for-the-events-calendar"),
      initialOpen: false
    }, /*#__PURE__*/React.createElement(TextControl, {
      __next40pxDefaultSize: true,
      ...
      title: __("Non-Featured Event Style", "events-block-for-the-events-calendar"),
      initialOpen: false
    }, /*#__PURE__*/React.createElement(ColorPicker, {
      ...
      title: __("Featured Event Style", "events-block-for-the-events-calendar"),
      initialOpen: false
    }, /*#__PURE__*/React.createElement(ColorPicker, {
    ...
    }, __("We hope you liked our plugin created events. Please share your valuable feedback.", "events-block-for-the-events-calendar"), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("a", {
      className: "components-button is-primary is-small",
      href: "https://wordpress.org/support/plugin/events-block-for-the-events-calendar/reviews/",
      target: "_blank"
    }, "Rate Us \u2605\u2605\u2605\u2605\u2605"))));
  }
}
...
const Layout = props => {
  const regex = /(<([^>]+)>)/gi;
  const FontFamily = [props.title_family_font, props.venue_family_font, props.description_family_font, props.date_family_font, props.link_family_font].filter(font => font && font !== 'Default').map(font => encodeURIComponent(font)).join('|');
  ...
  return /*#__PURE__*/React.createElement(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, props.display_header === true && props.eventHeaderType === 'show_header' && props.eventLayout !== 'minimal' && /*#__PURE__*/React.createElement("div", {
  ...
  }), props.eventLayout !== 'minimal' && /*#__PURE__*/React.createElement(React.Fragment, null, props.hide_venue == "no" && props.venue.length !== 0 && /*#__PURE__*/React.createElement("div", {

...
wp_enqueue_style( 'cool-plugins-events-addon-latest-db', EBEC_URL . 'admin/events-addon-page/assets/css/styles.min.css', array(), EBEC_VERSION, 'all' );
...
<header class="<?php echo esc_attr($prefix); ?>-top-header">
    <div class="<?php echo esc_attr($prefix); ?>-header-left">
        ...
        <h1><?php echo esc_html__('Events Calendar Addons', 'events-block-for-the-events-calendar'); ?></h1>
    </div>
    <div class="<?php echo esc_attr($prefix); ?>-header-right">
        <a href="<?php echo esc_url('https://eventscalendaraddons.com/demos/?utm_source=ebec_plugin&utm_medium=inside&utm_campaign=demo&utm_content=dashboard'); ?>" target="_blank" rel="noopener" class="<?php echo esc_attr($prefix); ?>-btn <?php echo esc_attr($prefix); ?>-btn-outline">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><g fill="currentColor"><path d="M10.5 8a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0"/><path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7a3.5 3.5 0 0 0 0 7"/></g></svg></span> <?php echo esc_html__('View Demos', 'events-block-for-the-events-calendar'); ?>
        </a>
        <a href="<?php echo esc_url('https://eventscalendaraddons.com/docs/?utm_source=ebec_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard'); ?>" target="_blank" rel="noopener" class="<?php echo esc_attr($prefix); ?>-btn <?php echo esc_attr($prefix); ?>-btn-primary">

...
<div class="<?php echo esc_attr($prefix); ?>-content">
    ...
    <span class="<?php echo esc_attr($prefix); ?>-indicator" style="background: var(--<?php echo esc_attr($prefix); ?>-success);"></span>
        <?php echo esc_html__('Currently Activated Addons', 'events-block-for-the-events-calendar'); ?>
        <?php /* translators: %d: number of active addons */ ?>
        <span class="<?php echo esc_attr($prefix); ?>-title-count"><?php echo esc_html( sprintf( _n( '%d Active Addon', '%d Active Addons', count( $activated_addons ), 'events-block-for-the-events-calendar' ), count( $activated_addons ) ) ); ?></span>
    </div>
    ...
    <span class="<?php echo esc_attr($prefix); ?>-indicator" style="background: #000;"></span> 
        <?php echo esc_html__('Premium Addons', 'events-block-for-the-events-calendar'); ?>
    </div>
    ...
    <span class="<?php echo esc_attr($prefix); ?>-indicator" style="background: #94a3b8;"></span> 
        <?php echo esc_html__('Available Addons', 'events-block-for-the-events-calendar'); ?>
    </div>

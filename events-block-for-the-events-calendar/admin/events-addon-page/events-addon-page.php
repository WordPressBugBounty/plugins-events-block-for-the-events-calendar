         ...
         */
            ...
            public function ect_dashboard_install_plugin() {
                ...
                if ( ! current_user_can( 'install_plugins' ) ) {
                    $status['errorMessage'] = __( 'Sorry, you are not allowed to install plugins on this site.', 'events-block-for-the-events-calendar' );
			    ...
			    if ( empty( $_POST['slug'] ) ) {
				    wp_send_json_error( array(
					    ...
					    'errorMessage' => __( 'No plugin specified.', 'events-block-for-the-events-calendar' ),
				    ));
			    }
			    ...
			    if ( ! in_array( $plugin_slug, $allowed_slugs, true ) ) {
				    wp_send_json_error( array(
					    ...
					    'errorMessage' => __( 'This plugin cannot be installed from here.', 'events-block-for-the-events-calendar' ),
				));
			    }
			...
			if ( in_array( $plugin_slug, $pro_plugins_slugs ) ) {
				...
				if ( ! current_user_can( 'activate_plugin', $plugin_slug ) ) {
					wp_send_json_error( array( 'message' => __( 'Permission denied', 'events-block-for-the-events-calendar' ) ) );
				}
				...
				wp_send_json_success( array(
                    'message'    => __( 'Plugin activated successfully', 'events-block-for-the-events-calendar' ),
                    'activated'  => true,
				...
				if ( is_wp_error( $result ) ) {
					...
					$status['errorMessage'] = __( 'Unable to connect to the filesystem. Please confirm your credentials.' , 'events-block-for-the-events-calendar' );
            ...
            function init_plugins_dasboard_page(){
                ...
                add_menu_page(
                    esc_html__( 'Events Addons', 'events-block-for-the-events-calendar' ),
                    esc_html__( 'Events Addons', 'events-block-for-the-events-calendar' ),
                    'manage_options',
                    $this->main_menu_slug,
                ...
                add_submenu_page(
                    $this->main_menu_slug,
                    esc_html__( 'Dashboard', 'events-block-for-the-events-calendar' ),
                    esc_html__( 'Dashboard', 'events-block-for-the-events-calendar' ),
                    'manage_options',
                    $this->main_menu_slug,
                    array( $this, 'displayPluginAdminDashboard' ),
            ...
            function displayPluginAdminDashboard(){
                ...
                if( !empty( $plugins ) || !empty($pro_plugins) ){
                    ...
                    echo '<div class="notice notice-warning ect-required-plugin-notice"><p>' . esc_html__( 'No plugins data available at the moment.', 'events-block-for-the-events-calendar' ) . '</p></div>';
                }
            }
            ...
            public function get_plugin_demo_docs_urls( $plugin_slug, $is_pro_plugin = false ) {
                ...
                $demo_url = 'https://eventscalendaraddons.com/demos/?utm_source=ebec_plugin&utm_medium=inside&utm_campaign=demo&utm_content=dashboard';
                $docs_url = 'https://eventscalendaraddons.com/docs/?utm_source=ebec_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard';
            ...
            private function render_plugin_card_demo_docs_links( $prefix, $plugin_slug, $is_pro_plugin ) {
                ...
                <div class="<?php echo esc_attr( $prefix ); ?>-card-links">
                    <a href="<?php echo esc_url( empty($urls['demo']) ? 'https://eventscalendaraddons.com/demos/?utm_source=ebec_plugin&utm_medium=inside&utm_campaign=demo&utm_content=dashboard' : $urls['demo'] ); ?>" target="_blank" rel="noopener" title="<?php esc_attr_e( 'View Demo', 'events-block-for-the-events-calendar' ); ?>">
                        ...
                        <?php esc_html_e( 'Demo', 'events-block-for-the-events-calendar' ); ?>
                    </a>
                    <a href="<?php echo esc_url( empty($urls['docs']) ? 'https://eventscalendaraddons.com/docs/?utm_source=ebec_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard' : $urls['docs'] ); ?>" target="_blank" rel="noopener" title="<?php esc_attr_e( 'Documentation', 'events-block-for-the-events-calendar' ); ?>">
                        ...
                        <?php esc_html_e( 'Docs', 'events-block-for-the-events-calendar' ); ?>
                    </a>
                </div>
                <?php
            }
            ...
            function render_plugin_card($prefix, $plugin, $type = 'activated'){
                ...
                <div class="<?php echo esc_attr($prefix); ?>-card">
                    <?php if ( ! empty( $has_update ) ) : ?>
                        <div title="<?php echo esc_attr__( 'Update available', 'events-block-for-the-events-calendar' ); ?>" class="<?php echo esc_attr($prefix); ?>-pulse-wrapper"></div>
                        <div title="<?php echo esc_attr__( 'Update available', 'events-block-for-the-events-calendar' ); ?>" class="<?php echo esc_attr($prefix); ?>-notification-dot"></div>
                    <?php endif; ?>
                    
                    <?php if ( $is_pro_plugin ) : ?>
                        <span class="<?php echo esc_attr($prefix); ?>-badge <?php echo esc_attr($prefix); ?>-badge-premium"><?php echo esc_html__( 'Pro', 'events-block-for-the-events-calendar' ); ?></span>
                    <?php endif; ?>
                    ...
                    <div class="<?php echo esc_attr($prefix); ?>-info">
                        ...
                        <?php if ( $type === 'activated' ) : ?>
                            <div class="<?php echo esc_attr($prefix); ?>-badge-group">
                                <div class="<?php echo esc_attr($prefix); ?>-active-update">
                                    <span class="<?php echo esc_attr($prefix); ?>-badge <?php echo esc_attr($prefix); ?>-badge-active"><?php echo esc_html__( 'Active', 'events-block-for-the-events-calendar' ); ?></span>
                        ...
                        <?php elseif ( $type === 'available' ) : ?>
                            <div class="<?php echo esc_attr($prefix); ?>-card-footer">
                                ...
                                >
                                    <?php echo $needs_activation ? esc_html__( 'Activate Now', 'events-block-for-the-events-calendar' ) : esc_html__( 'Install Now', 'events-block-for-the-events-calendar' ); ?>
                                </button>
                                <?php $this->render_plugin_card_demo_docs_links( $prefix, $plugin_slug, $is_pro_plugin ); ?>
                            </div>
                        <?php elseif ( $type === 'pro' ) : ?>
                            <div class="<?php echo esc_attr($prefix); ?>-card-footer">
                                ...
                                <a href="<?php echo esc_attr( $buy_link ); ?>"
                                   ...
                                   class="button <?php echo esc_attr($prefix); ?>-button-primary <?php echo esc_attr($prefix); ?>-btn-buy">
                                    <?php echo esc_html__( 'Buy Pro', 'events-block-for-the-events-calendar' ); ?>
                                </a>
            ...
            public function enqueue_required_scripts(){
                ...
                if (in_array($screen_id, $parent_file)){
                    wp_enqueue_style('cool-plugins-events-addon', EBEC_URL .'admin/events-addon-page/assets/css/styles.min.css', array(), EBEC_VERSION, 'all');
                }
                // Enqueue JavaScript file
                wp_enqueue_script( 'cool-plugins-events-addon', EBEC_URL .'admin/events-addon-page/assets/js/script.js', array('jquery'), EBEC_VERSION, true);
                ...
                // Localize script with required data
                 wp_localize_script( 'cool-plugins-events-addon', 'cp_events', array(
                    ...
                    'prefix'         => 'ect',
                    'activated_label' => esc_html__( 'Activated', 'events-block-for-the-events-calendar' )
                ));
            }
